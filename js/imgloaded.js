 ...
 */
  ...
  const config = {
    smallSrc: 'https://api.qjqq.cn/api/Img', // 小图链接 尽可能配置小于100k的图片
    largeSrc: 'https://api.qjqq.cn/api/Img', // 大图链接 最终显示的图片
    mobileSmallSrc: 'https://api.qjqq.cn/api/Img', // 手机端小图链接 尽可能配置小于100k的图片
    mobileLargeSrc: 'https://api.qjqq.cn/api/Img', // 手机端大图链接 最终显示的图片
    enableRoutes: ['/'],
    };
